...
const faqSections = ref([
  {
    ...
    items: [
      ...
      {
        question: t('Что такое события?'),
        answer: t('Временные ивенты, которые проходят по календарю. В активный период открываются тематические задания и награды. Вне диапазона дат раздел недоступен. Даты проведения можно посмотреть в «Календаре событий» в Панели участника.')
      },
    ]
  },
  {

<script setup>
	...
	const themes = [
		{ key: 'house', name: 'Дом', img: HomeImg, position: { top: '5%', left: '10%', rotate: '-5deg' } },
		{ key: 'zeit', name: 'Время', img: Clock, position: { top: '25%', left: '55%', rotate: '4deg' } },
		{ key: 'family', name: 'Семья', img: Family, position: { top: '2%', left: '60%', rotate: '8deg' } },
		{ key: 'food', name: 'Еда', img: Food, position: { top: '45%', left: '13%', rotate: '-3deg' } },
		{ key: 'purchases', name: 'Покупки', img: Purchase, position: { top: '30%', left: '35%', rotate: '-6deg' } },
		{ key: 'health', name: 'Здоровье', img: Health, position: { top: '20%', left: '2%', rotate: '7deg' } },
		{ key: 'weather', name: 'Погода', img: Weather, position: { top: '70%', left: '55%', rotate: '-5deg' } },
		{ key: 'clothes', name: 'Одежда', img: Clothes, position: { top: '48%', left: '65%', rotate: '-3deg' } },
		{ key: 'transport', name: 'Транспорт', img: Transport, position: { top: '55%', left: '30%', rotate: '4deg' } },
		{ key: 'school', name: 'Школа', img: School, position: { top: '68%', left: '5%', rotate: '-8deg' } },
		{ key: 'travel', name: 'Путешествия', img: Travel, position: { top: '2%', left: '30%', rotate: '3deg' } }
	]
	...
	const selectLevel = (levelNumber) => {
		if (levelNumber > 1 && !isLevelCompleted(levelNumber - 1)) {
			triggerChalkMessage(`Сначала пройдите Уровень ${levelNumber - 1}!`)
		} else {
	...
	const handleModuleClick = (module) => {
		if (isModuleUnlocked(selectedLevel.value, module.id)) {
			...
			triggerChalkMessage('Сначала пройдите предыдущий модуль!')
		}
	}
...
<template>
	<div class="classroom-layout">
		...
		<div class="corkboard">
			<h2 class="corkboard-title">Выберите тему</h2>

    ...
    <div class="main-content">
      ...
      <div class="tab-content-wrapper">
        <div v-if="activeTab === 'info'" class="tab-content">
          ...
          <div @click="toggle" class="subscription-row"
               :class="{'open' : isToggle}"
          >
            <div class="subscription-title-wrapper">
              ...
              <img class="sub__arrow" src="../assets/images/arrowNav.svg" alt="">
            </div>
            ...
            <div class="subscription-status">
              <template v-if="authStore.isPremium && !authStore.subscriptionCancelled">
                ...
                <button class="open__cancel-modal" @click="openCancelModal">Отменить подписку</button>
              </template>

            ...
            <section v-for="(section, index) in pageSections" :key="index" class="topic-card"
                ...
                <div v-if="section.type === 'quiz'">
                    <div v-if="!quizFinished" class="quiz-container">
                        <p class="quiz-progress">{{ t('preposition.quest')}} {{ currentQuestionIndex + 1 }} из {{ section.questions.length
                            }}</p>
                        <h3 class="quiz-question">{{ section.questions[currentQuestionIndex].sentence.replace('___',
                            '...') }}</h3>
                        ...
                        <div class="quiz-feedback">
                            ...
                            <p v-if="feedback === 'incorrect'" class="feedback-text">❌ {{ t('preposition.incorrect')}} <b>{{
                                section.questions[currentQuestionIndex].answer }}</b></p>
                        </div>
    ...
    const pageSections = ref([
        ...
        },
        {
            ...
            questions: [
                ...
                {sentence: '___ des schlechten Wetters bleiben wir zu Hause.', options: ['Trotz', 'Wegen', 'Statt'], answer: 'Wegen'},
            ]
        }
    ]);
...
<style scoped>
    ...
    @media (max-width: 768px) {
        ...
        .topic-card {
            padding: 1.5rem;
            box-shadow: 6px 6px 0px rgba(30, 30, 30, 0.8);
        }

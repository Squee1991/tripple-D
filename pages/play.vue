                ...
                <div class="duel__header">
                    ...
                    <div @click="openModal">
                        <img class="duel__question-img" :title="t('hoverTitle.duelInfo')"
                             src="../assets/images/question.svg" alt="">
                    </div>
                </div>
...
async function handleFindGameClick(level) {
    try {
        ...
        selectedLevel.value = level; // Сохраняем уровень для статистики
        ...
        if (mode.value === 'online') {
            ...
            await gameStore.findGame(level);
        } else {
        ...
        error.value = t('wordDuel.searchError');
    } finally {

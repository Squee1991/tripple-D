...
export const regions = [
	{
		...
		level: 1,
		desc: "Просторные земли, где каждый герой начинает своё путешествие. Здесь ты освоишь основы языка и получишь первые задания. Атмосфера спокойная, но именно отсюда начинаются великие приключения.",
		color: "#f28d39",
		icon: FirstStep
	},
	{

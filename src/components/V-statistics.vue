    ...
    <div class="stats__wrapper">
      ...
      <div class="panel-scroll">
        <template v-if="viewMode === 'articles'">
          <div v-if="hasAnyTopic">
            <div class="select__block">
              <div class="topic-slider">
                <button class="nav-btn" @click="prevTopic">
                ...
                <button class="nav-btn" @click="nextTopic">
...
const currentRegionTitle = computed(() => {
  ...
  return r?.title || r?.name || `regions.${r?.pathTo}` || r?.pathTo || ''
})

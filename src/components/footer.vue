    ...
    <footer class="footer">
        ...
        <div class="footer__container">
            ...
            <div class="footer__social">
                ...
                <div class="social__item" @click="toDiscord">
                ...
                <a href="https://t.me/+9JGuY_NwmQhlZjM0" target="_blank" class="social__item">

                    <div class="icon">

                        <!-- Telegram -->

                        <svg height="28" viewBox="0 0 176 176" width="28" xmlns="http://www.w3.org/2000/svg"
                             fill="currentColor">
                ...
                <a href="https://www.tiktok.com" target="_blank" class="social__item">
                    <div class="icon">
                        <svg height="28" viewBox="0 0 256 256" width="28" xmlns="http://www.w3.org/2000/svg"
                             fill="currentColor">
                            <path d="M180.3 72.4c-9.7-5.8-16.7-15.1-19.5-26.1v-3.6h-23.4v110.4c0 12.9-10.5 23.4-23.4 23.4S90.6 166 90.6 153.1s10.5-23.4 23.4-23.4c2.1 0 4.3.3 6.3.8V104c-2.1-.2-4.2-.3-6.3-.3-25.6 0-46.3 20.8-46.3 46.3S88.4 196.3 114 196.3s46.3-20.8 46.3-46.3v-54.9c8.9 6.5 19.5 10.7 30.9 11.8v-23.4c-4.1-.5-8.1-1.7-11.9-3.5z"/>
                        </svg>

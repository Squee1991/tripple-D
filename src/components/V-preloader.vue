...
const phraseSet = [
  { text: 'Artikel werden beschworen…', color: '#1e293b' },
  { text: 'Wörter werden geschmiedet…', color: '#f59e0b' },
  { text: 'Der, die, das – fast da!', color: '#ef4444' },
  { text: 'Grammatik-Magie wird geladen…', color: '#3b82f6' },
  { text: 'Aussprache wird vorbereitet…', color: '#10b981' },
  { text: 'Karten werden gemischt…', color: '#8b5cf6' },
  { text: 'Pluralformen erscheinen…', color: '#ec4899' },
  { text: 'Genauigkeit +10%…', color: '#22c55e' }
]
